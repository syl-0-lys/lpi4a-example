...
def draw_bbox(image, bboxes, classes=read_class_names("label_names.names"), show_label=True):
    """
...
original_image = cv2.imread("detect1.jpg")
'''
...
'''
print(" ******* run yolov8 and postprocess *******")
model_inference_command = "./yolov8n_example shl.hhb.bm ./hhb_out/hhb.bm detect1.jpg"
...
cv2.imwrite("v8_result.jpg", image)
t2 = time.time()
print(f'total_time = {t2-t1:.4f}s')
