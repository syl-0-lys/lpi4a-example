...
//printf("graph_created \n");
    ...
    float *sess1_inputf[input_num];
    int8_t *sess1_inputd[input_num];
    void *input_temp[input_num];
...
//printf("--------------sess0 op---------------");
        ...
        for(j=0; j<sess0_output_num; j++){
            ...
            memcpy(input_temp[j], sess1_inputd[j], input_size[j]);
