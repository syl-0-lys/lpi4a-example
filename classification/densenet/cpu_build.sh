...
hhb -D -f densenet.pb --data-scale 0.017 --data-mean "124 117 104"  --board c920  --postprocess save_and_top5 --input-name "Placeholder" --output-name "densenet121/predictions/Reshape_1" --input-shape "1 224 224 3" --quantization-scheme float16
