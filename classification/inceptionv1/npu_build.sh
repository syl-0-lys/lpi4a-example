...
hhb -f inceptionv1.pb --data-scale 0.0039 --data-mean "127.5 127.5 127.5"  --board th1520  --postprocess save_and_top5 --input-name "input" --output-name "InceptionV1/Logits/Predictions/Reshape_1" --input-shape "1 224 224 3" --calibrate-dataset persian_cat.jpg  --quantization-scheme "int8_asym" -D
