...
hhb -D -f inceptionv4.pb --data-scale 0.0039 --data-mean "127.5 127.5 127.5"  --board c920  --postprocess save_and_top5 --input-name "input" --output-name "InceptionV4/Logits/Predictions" --input-shape "1 299 299 3" --quantization-scheme float16
